...
contract SimpleNft_Enzo_test is Helper {
  uint8 LOG_LEVEL = 0;
  ...
  function test_SimpleNft_Enzo_basic_name() public {
    assertEq(nftContract.name(), NAME_ERC721);
  }

  function test_SimpleNft_Enzo_basic_symbol() public {
    assertEq(nftContract.symbol(), SYMBOL_ERC721);
  }

  function test_SimpleNft_Enzo_basic_canWeStartMinting() public {
    help_startMinting();
  ...
  function test_SimpleNft_Enzo_basic_baseUri() public {
  ...
  function test_SimpleNft_Enzo_mint() public {
    vm.prank(ADMIN);
  ...
  function test_SimpleNft_Enzo_mint_2Tokens() public {
    vm.prank(ADMIN);
  ...
  function test_SimpleNft_Enzo_mint_2Tokens_for_price_of_one() public {
    vm.prank(ADMIN);
    vm.deal(ADMIN, 0.5 ether);
  ...
  function test_SimpleNft_Enzo_basic_contractUri() public {
  ...
  function test_SimpleNft_Enzo_any_contractUri() public {
    assertEq(nftContract.contractURI(), '');
    vm.prank(address(2));
